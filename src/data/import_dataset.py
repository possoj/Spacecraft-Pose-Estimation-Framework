...
from src.data.datasets.dspeed import import_dspeed, import_dspeed_camera, import_dspeed_video
...
def load_dataset(
    ...
    elif 'dspeed' in path and dataset_name == 'still':
        data, split = import_dspeed(spe_utils, path, batch_size, img_size, rot_augment, other_augment, shuffle, seed)
    elif 'dspeed' in path and dataset_name == 'video':
        data, split = import_dspeed_video(spe_utils, path, batch_size, img_size)
    else:
