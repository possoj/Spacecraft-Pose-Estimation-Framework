...
def import_speed_plus(
    ...
    datasets = {
        ...
        'valid': SPEDataset(spe_utils, default_transforms, None, os.path.join(path, 'synthetic', 'images'),
                            os.path.join(path, 'synthetic', 'validation.json')),
        'sunlamp': SPEDataset(spe_utils, default_transforms, None,
                              os.path.join(path, 'sunlamp', 'images'), os.path.join(path, 'sunlamp', 'test.json')),
        'lightbox': SPEDataset(spe_utils, default_transforms, None,
